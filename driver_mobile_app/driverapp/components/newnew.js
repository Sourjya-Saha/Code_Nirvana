...
const toggleDeliveryDetails = () => {
  ...
  Animated.spring(slideAnim, {
    toValue: showDeliveryDetails ? 0 : 1,
...
const ControlPanel = () => (
  ...
  >
    {!showDeliveryDetails ? (
      ...
      <DeliveryDetails onClose={toggleDeliveryDetails} />
    )}
  </Animated.View>
);

const DeliveryDetails = ({ onClose }) => (
  <View style={styles.deliveryDetailsContainer}>
    <View style={styles.deliveryDetailsHeader}>
      <View style={styles.headerLeft}>
        ...
        <Text style={styles.cartIdBadge}>{`#${cartId}`}</Text>
      </View>
      <TouchableOpacity onPress={onClose} style={styles.closeButton}>
        <MaterialIcons name="close" size={24} color="#1E2A78" />
      </TouchableOpacity>
    </View>
  ...
  <View style={styles.infoContainer}>
    <View style={styles.routeHeaderContainer}>
      <View style={styles.routeHeaderLeft}>
        <MaterialIcons name="local-shipping" size={24} color="#1E2A78" />
        <Text style={styles.routeHeaderText}>Delivery Details </Text>
...
{navigationState.isActive && currentRoute?.metadata && (
    ...
    {!navigationState.isActive && (
      ...
      {navigationState.isActive ? <NavigationOverlay /> : <ControlPanel />}
    </View>
  );
};
