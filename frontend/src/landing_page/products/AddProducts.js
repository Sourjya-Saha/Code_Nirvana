    ...
    try {
      ...
      if (response.ok) {
        ...
        setProduct({
          ...
          quantity_of_uom: '', shelf_num: '', uom_id: '',
          picture_of_the_prod: null, description: '', user_id: userId,
        });
    ...
    <>
      ...
      <div className="dashboard-cont">
        ...
        <div className="page-title-bar">
          ...
          <h1 className="page-title-text">Add New Product</h1>
        </div>
      ...
      <style>{`
        .dashboard-cont {
          ...
          padding-left: 110px; padding-top: 210px; padding-right: 24px; padding-bottom: 40px;
        ...
        .card-title {
          font-size: 1.1rem; font-weight: 700; position: relative; z-index: 2;
          text-transform: uppercase; letter-spacing: 0.05em; margin: 0; color: white;
        }
        .shimmer-effect {
        ...
        .form-group label { font-weight: 600; color: #4b5563; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.05em; }
        .form-input {
          padding: 11px 14px; border-radius: 8px; border: 1px solid #d1d5db; font-size: 0.95rem;
          font-family: 'Poppins', sans-serif; background-color: #f9fafb; transition: all 0.3s ease;
          color: #111827; width: 100%; box-sizing: border-box;
        }
        .form-input:focus {
          outline: none; border-color: #4F46E5;
          box-shadow: 0 0 0 3px rgba(79,70,229,0.1); background-color: white;
        }
        ...
        .image-upload-zone:hover { border-color: #4F46E5; }
        .upload-label {
          display: flex; flex-direction: column; align-items: center;
          justify-content: center; text-align: center; padding: 28px 16px;
          cursor: pointer; gap: 8px; width: 100%; box-sizing: border-box;
        }
        .upload-icon {
          width: 44px; height: 44px; background: linear-gradient(135deg, #4F46E5, #6366F1);
          border-radius: 50%; display: flex; align-items: center; justify-content: center;
          color: white; margin: 0 auto; margin-bottom: 10px; padding: 10px; box-sizing: border-box;
        }
        .upload-icon svg { width: 100%; height: 100%; display: block; }
        .upload-text { display: block; font-weight: 600; color: #4F46E5; font-size: 0.95rem; }
        .upload-subtext { display: block; font-size: 0.78rem; color: #9ca3af; }
        ...
        .submit-product-btn {
          ...
          padding: 13px 24px; border-radius: 8px; border: none; font-weight: 700; font-size: 1rem;
          font-family: 'Poppins', sans-serif; cursor: pointer; transition: all 0.3s ease;
          background-color: #10b981; color: white; text-transform: uppercase; letter-spacing: 0.05em;
        }
        .submit-product-btn:hover:not(:disabled) { background-color: #059669; transform: translateY(-2px); }
