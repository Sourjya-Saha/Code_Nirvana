    ...
    <>
      ...
      <div className="dashboard-cont">
        ...
        <div className="page-title-bar">
          ...
          <h1 className="page-title-text">Update your Inventory</h1>
        </div>
          ...
          <div className="grid-card product-form-card">
            ...
            <div className="form-content">
              ...
              <div className="form-actions">
                <button
                  type="button"
                  className="payment-button submit-product-btn"
...
.upload-icon {
  ...
  display: block;     /* 🔥 removes inline offset */
        ...
        .submit-product-btn:hover:not(:disabled) {
        ...
        .submit-product-btn:active:not(:disabled) {
